...
public class Budget {
    ...
    public void voegInkomstToe(Inkomsten inkomst) {
        inkomstenList.add(inkomst);
    }

    // Methode om een uitgave toe te voegen
    public void voegUitgaveToe(Uitgaven uitgave) {
        uitgavenList.add(uitgave);
    }

    // Methode om een inkomst te verwijderen
    public void verwijderInkomst(Inkomsten inkomst) {
        inkomstenList.remove(inkomst);
    }

    // Methode om een uitgave te verwijderen
    public void verwijderUitgave(Uitgaven uitgave) {
        uitgavenList.remove(uitgave);
    }
    ...
    public double berekenGesaved() throws IOException {
        ...
        List<Inkomsten> inkomstenList = DataStorage.loadInkomsten(this.naam);
        List<Uitgaven> uitgavenList = DataStorage.loadUitgaven(this.naam);
