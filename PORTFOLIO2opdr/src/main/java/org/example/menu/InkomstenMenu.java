...
public class InkomstenMenu {
    ...
    private void voegInkomstToe() {
        ...
        try {
            DataStorage.saveInkomsten(inkomstenList, budget.getNaam()); // Opslaan in een tekstbestand
    ...
    private void verwijderInkomst() {
        ...
        try {
            inkomstenList = DataStorage.loadInkomsten(budget.getNaam());
        } catch (IOException e) {
        ...
        try {
            DataStorage.saveInkomsten(inkomstenList, budget.getNaam()); // Update het bestand na het verwijderen van de inkomst
